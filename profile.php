            ...
            <div id="layoutSidenav_content" style="background-color: #fafafa">
                <main>
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="index-admin.php" style="color: #33abf6">Pusat Data</a></li>
                    </ol>
                    <center
                    ...
                    <div class="main-banner">
                        <center>
                            <div class="card"
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-footer" align="justify"
                                                    ...
                                                    <b style="color: #33abf6;">Tentang Saya<a type="submit"
                                                            href="edit/edit-bio.php" style="margin-left: 10px"><i
                                                    ...
                                                    <a style="font-size: 12px" align="justify">
                                                        ...
                                                        {
                                                            echo "<label style='font-weight: lighter;'><b>-</b> <em>Kosong</em> <b>-</b></label>";
                                                        }
                                                        ?>
                                                    </a>
                                                </div>
                                    ...
                                    <table border="0" align="center" style="margin-top: 3%">
                                        <tr>
                                            <td>
                                                <a type="submit" class="btn btn-primary" href="edit/edit-profile.php"
                                                    style="box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75);"><b><i
                                                            class='bi bi-pencil-square'></i> Edit
                                                        Profil</b></a>
                                            </td>
                                        </tr>
                            ...
                            <a type="submit" class="btn btn-danger" href="index-admin.php" style="margin-bottom: 2%"><b>←
                                    Home</b></a>
                        </center>
                    </div>
                </main>
