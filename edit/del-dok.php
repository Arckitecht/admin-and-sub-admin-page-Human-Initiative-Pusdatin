...
if (isset($_SESSION['username'])):
    $bookid = $_POST['BookID'];
    //Define the query
    $querys = "DELETE FROM book WHERE BookID='$bookid'";
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <b>Data dokumen&nbsp;</b><b style='color: red'>
                                                        <?php echo '<label style="color: black; font-weight: bold">(ID:</label>&nbsp;' . $bookid . '<label style="color: black; font-weight: bold">)</label>'; ?>
                                                    </b><b>&nbsp;berhasil dihapus!</b>
                                                </div>
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <img src='../assets/images/check-removed.gif'>
                                                </div>
                                                <a type="submit" class="btn btn-primary" href="../lihat/lihat-dok.php"
