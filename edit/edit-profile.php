...
if (isset($_SESSION['username'])):
    ...
    if (isset($_POST["submit"]))
    {
        ...
        if ($valid)
        {
            if ($nama == '' and $notelp == '' and $email == '' and $usernamee == '' and $TmptLahir == '' and $passwordreg == '' and $unit1 == '-- Pilih Unit 1 --' and $unit2 == '-- Pilih Unit 2 --' and $unit3 == '-- Pilih Unit 3 --' and $unit4 == '-- Pilih Unit 4 --' and $lahir == '')
            {
