            ...
            <main>
                ...
                <div class="card mb-4" style="margin-left: 1%; margin-right: 1%; border: 1px solid #2e2d2d">
                    ...
                    <div class="card-body tabel-mahasiswa cell-border">
                        ...
                        <a type="submit" class="btn btn-success" href="../input-subadmin/tamb-jnsd-subadmin.php" title='Tambah Jenis Dokumen Baru'><b>+
                                Baru</b></a>
                        ...
                        <table id="admin-tabel-mahasiswa1" class="cell-border table-sm dataTable" cellspacing="1"
                            ...
                            <tbody class="table-bordered table-hover"
                                ...
                                while ($row = $result->fetch_object())
                                {
                                    ...
                                    <td>" . $row->JenisDok . "</td>
                                    <td>
                                        <form action='../edit-subadmin/edit-ktgr-jnsd-subadmin.php?name=" . $row->JenisDok . "' method='GET'>
                                            <input type='hidden' name='jenisdok-sub' value='" . $row->JenisDok . "'>
                                            <input type='submit' class='btn btn-primary' name='submit' value='📝' title='Edit Jenis Dokumen ini'>
                                        </form>
                                    </td>
                                    <td>
                                        <form action='../edit-subadmin/del-ktgr-jnsd-subadmin.php?name=" . $row->ID . "' method='POST'>
                        ...
                        <a type="submit" class="btn btn-success" href="../input-subadmin/tamb-jnsa-subadmin.php" title='Tambah Jenis Akses Baru'><b>+
                                Baru</b></a>
                        <button onclick='window.location.reload(true);' class="btn btn-danger" style="float: right" title='Refresh'><b><i
                                    class="bi bi-arrow-clockwise"></i></b></button>
                        <br><br>
                        <table id="admin-tabel-mahasiswa2" class="cell-border table-sm dataTable" cellspacing="1"
                            ...
                            <tbody class="table-bordered table-hover"
                                ...
                                while ($rows = $resultsss->fetch_object())
                                {
                                    ...
                                    <td>
                                        <form action='../edit-subadmin/edit-ktgr-jnsa-subadmin.php?name=" . $rows->JenisAkses . "' method='GET'>
                                            <input type='hidden' name='jenisakses-sub' value='" . $rows->JenisAkses . "'>
                                            <input type='submit' class='btn btn-primary' name='submit' value='📝' title='Edit Jenis Akses ini'>
                                        </form>
                                    </td>
                                    <td>
                                        <form action='../edit-subadmin/del-ktgr-jnsa-subadmin.php?name=" . $rows->ID . "' method='POST'>
                        ...
                        <a type="submit" class="btn btn-success" href="../input-subadmin/tamb-ktgr-subadmin.php" title='Tambah Kategori Dokumen Baru'><b>+
                                Baru</b></a>
                        <button onclick='window.location.reload(true);' class="btn btn-danger" style="float: right" title='Refresh'><b><i
                                    class="bi bi-arrow-clockwise"></i></b></button>
                        <br><br>
                        <table id="admin-tabel-mahasiswa3" class="cell-border table-sm dataTable" cellspacing="1"
                            ...
                            <tbody class="table-bordered table-hover"
                                ...
                                while ($rowss = $resultss->fetch_object())
                                {
                                    ...
                                    <td>
                                        <form action='../edit-subadmin/edit-ktgr-dok-subadmin.php?name=" . $rowss->KategoriDok . "' method='GET'>
                                            <input type='hidden' name='ktgrdok-sub' value='" . $rowss->KategoriDok . "'>
                                            <input type='submit' class='btn btn-primary' name='submit' value='📝' title='Edit Kategori Dokumen ini'>
                                        </form>
                                    </td>
                                    <td>
                                        <form action='../edit-subadmin/del-ktgr-dok-subadmin.php?name=" . $rowss->ID . "' method='POST'>
