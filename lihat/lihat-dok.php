                    ...
                    <div class="card-body tabel-mahasiswa cell-border">
                        ...
                        <table id="admin-tabel-mahasiswa" class="cell-border table-sm dataTable" cellspacing="1"
                            ...
                            <tbody class="table-bordered table-hover"
                                ...
                                <?php
                                $query  = "SELECT * FROM `book` WHERE (Gambar!='' AND PDF!='' AND Tglinput!='') ORDER BY BookID_Num";
                                ...
                                while ($row = $result->fetch_object())
                                {
                                    ...
                                    <td style='word-wrap: break-word;'>
                                        " . $row->KategoriDok . "
                                        <form action='../edit/edit-ktgr-dok-dok.php?name=" . $row->BookID . "' method='GET'>
                                            <input type='hidden' name='IDBook' value='" . $row->BookID . "'>
                                    ...
                                    <td>
                                        <form action='../edit/edit-dok.php?name=" . $row->BookID . "' method='GET'>
                                            <input type='hidden' name='IDBook' value='" . $row->BookID . "'>
                                            <input type='submit' class='btn btn-primary' name='submit' value='📝' title='Edit Dokumen ini'>
                                        </form>
                                    </td>
                                    <td>
                                        <form action='../edit/del-dok.php?name=" . $row->BookID . "' method='POST'>
                            ...
                            <tr
                                ...
                                <td style='border: 0px solid #2e2d2d;'>Edit</td>
                                <td style='border: 0px solid #2e2d2d;'>Hapus</td>
                                <td style='width: 30px; border: 0px solid #2e2d2d;'>ID</td>
                            </tr>
                        </table>
                ...
                <script>
                    $(document).ready(function () {
                        $('#admin-tabel-mahasiswa').DataTable({
                            ...
                            order: [],
                            "columnDefs": [
                                { "orderable": false, "targets": [0, 16, 17, 18] },
