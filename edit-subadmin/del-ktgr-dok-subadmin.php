...
if (isset($_SESSION['username'])):
    ...
    //Define the query
    $querys = "DELETE FROM `kategori_dok` WHERE ID='" . $ktgrid . "'";
            ...
            <div id="layoutSidenav_content" style="background-color: #fafafa">
                <main>
                    <div class="container-fluid" style="width: 70%; margin-top: 3%; margin-bottom: 3%">
                        <h3 class="my-3" style="color: #2e2d2d">Hapus Kategori Dokumen <b
                            ...
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-header" style="background-color: #2e2d2d;">
                                        ...
                                        <b style="color: white;">Hapus Kategori Dokumen</b>
                                    </div>
                                    <div class="card-body">
                                        <div class="container overflow-hidden">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <b>Data kategori dokumen&nbsp;</b><b style='color: red'>
                                                        <?php echo $ktgrnama; ?>
                                                ...
                                                <a type="submit" class="btn btn-primary"
                                                    href="../lihat-subadmin/lihat-ktgr-subadmin.php"
