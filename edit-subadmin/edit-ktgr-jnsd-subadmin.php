...
if (isset($_SESSION['username'])):
    ...
    if (isset($_POST["butonedit"]))
    {
        ...
        {
            $error_ktgred = "*Jenis Dokumen ini sudah ada dalam database! Masukkan yang lain!<br>";
            $valid       = FALSE;
        }

        if ($valid)
        {
            $editktgrdok = 'UPDATE `jenis_dok` SET JenisDok="' . $editktgr . '" WHERE JenisDok="' . $ktgr1 . '" ';
        ...
        <div id="layoutSidenav_content" style="background-color: #fafafa">
            <main>
                <div class="container-fluid" style="width: 70%;">
                    <h3 class="my-3" style="color: #2e2d2d">Edit Jenis Dokumen <b
                        ...
                        <div class="col">
                            <div class="card mb-4">
                                <div class="card-header" style="background-color: #2e2d2d;">
                                    ...
                                    <b style="color: white;">Form Edit Jenis Dokumen</b>
                                </div>
                                <div class="card-body">
