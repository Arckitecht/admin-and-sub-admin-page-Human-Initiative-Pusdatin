...
if (isset($_SESSION['username'])):
    ...
    if (isset($_POST["butonedit"]))
    {
        ...
        {
            $error_ktgred = "*Jenis Akses ini sudah ada dalam database! Masukkan yang lain!<br>";
            $valid        = FALSE;
        }

        if ($valid)
        {
            $editktgrdok = 'UPDATE `jenis_akses` SET JenisAkses="' . $editktgr . '" WHERE JenisAkses="' . $ktgr2 . '" ';
        ...
        <div id="layoutSidenav_content" style="background-color: #fafafa">
            <main>
                <div class="container-fluid" style="width: 70%;">
                    <h3 class="my-3" style="color: #2e2d2d">Edit Jenis Akses <b
                        ...
                        <div class="col">
                            <div class="card mb-4">
                                <div class="card-header" style="background-color: #2e2d2d;">
                                    ...
                                    <b style="color: white;">Form Edit Jenis Akses</b>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row mb-3" style="align-items: center; justify-content: center;">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="inputktgr2"
                                                        name="inputktgr2" value="<?php
                                                        $ktgrjnsa = $_GET['jenisakses-sub'];
                                                        if (isset($ktgr2))
                                                        {
                                                            echo $ktgrjnsa;
                                                        }
