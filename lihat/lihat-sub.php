            ...
            <main>
                ...
                <div class="card mb-4" style="margin-left: 1%; margin-right: 1%; border: 1px solid #2e2d2d">
                    ...
                    <div class="card-body tabel-mahasiswa cell-border">
                        <a type="submit" class="btn btn-success" href="../input/regist-sub.php"
                            title='Tambah Sub-Admin Baru'><b>+ Baru</b></a>
                        ...
                        <table id="admin-tabel-mahasiswa" class="cell-border table-sm dataTable" cellspacing="1"
                            ...
                            <tbody class="table-bordered table-hover"
                                ...
                                while ($row = $result->fetch_object())
                                {
                                    ...
                                    {
                                        $editakun = "<form action='../edit/cek-akses.php?name=" . $row->ID . "' method='POST'>
                                        <input type='hidden' name='ID-user' value='" . $row->ID . "," . $row->Akses . "," . $row->Nama . "'>
                                        <input type='submit' class='btn btn-primary' name='submit' value='📝' title='Edit User ini'>
                                    </form>";
                                    }
                                    else
                                    {
                                        $editakun = "<a type='submit' class='btn btn-primary' href='../edit/edit-profile.php' title='Edit Profil Anda'>📝</a>";
                                    }
                                    ...
                                    <td>" . $editakun . "</td>
                                    <td>
                                        <form action='../edit/del-sub.php?name=" . $row->ID . "' method='POST'>
                                            <input type='hidden' name='ID' value='" . $row->ID . "," . $row->Akses . "," . $row->Nama . "'>
                                            <input type='submit' class='btn btn-danger' name='submit' value='🗙' onclick='return checkDelete()' title='Hapus User ini'>
                                        </form>
                                    </td>";
                                    $i++;
                                }
                ...
                <script language="JavaScript" type="text/javascript">
                    function checkDelete() {
                        return confirm('Anda yakin untuk menghapus user ini?');
                    }
                </script>
                <script>
