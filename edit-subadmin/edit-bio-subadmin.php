...
if (isset($_SESSION['username'])):
    ...
    if (isset($_POST["butonedit"]))
    {
        ...
        if (strlen($editbio) > 180)
        {
            $error_bioed = "*Maksimal 180 karakter!";
            $valid       = FALSE;
        }
                                    ...
                                    <div class="container overflow-hidden">
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="row mb-3" style="align-items: center; justify-content: center;">
                                                <label for="editbio" class="col-sm-2 col-form-label"><b>Tentang Saya</b><b
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="editbio" name="editbio"
                                                        ...
                                                        <a style="color: black; font-size: 12px;">*Maksimal 180 karakter!</a>
                                                    </div>
                                                </div>
