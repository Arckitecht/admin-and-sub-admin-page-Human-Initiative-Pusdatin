...
if (isset($_SESSION['username'])):
    ...
    //Define the query
    $querys = "DELETE FROM `jenis_akses` WHERE ID='$ktgrid'";
            ...
            <div id="layoutSidenav_content" style="background-color: #fafafa">
                <main>
                    <div class="container-fluid" style="width: 70%; margin-top: 3%; margin-bottom: 3%">
                        <h3 class="my-3" style="color: #2e2d2d">Hapus Jenis Akses <b
                            ...
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-header" style="background-color: #2e2d2d;">
                                        ...
                                        <b style="color: white;">Hapus Jenis Akses</b>
                                    </div>
                                    <div class="card-body">
                                        <div class="container overflow-hidden">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <b>Data jenis akses&nbsp;</b><b style='color: red'>
                                                        <?php echo $ktgrnama; ?>
