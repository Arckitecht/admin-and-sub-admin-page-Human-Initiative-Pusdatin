...
if (isset($_SESSION['username'])):
    ...
    if (isset($_POST["tambah"]))
    {
        ...
        $resultambil = mysqli_query($conn, "SELECT * FROM jenis_dok WHERE JenisDok='$ktgr1'");
        if (empty($_POST['inputktgr1']))
        {
        ...
        {
            $error_ktgr1 = "*Jenis Dokumen ini sudah ada dalam database! Masukkan yang baru!<br>";
            $valid       = FALSE;
        }

        if ($valid)
        {
            $result = mysqli_query($conn, "INSERT INTO jenis_dok (JenisDok) VALUES('$ktgr1')");
    ...
    <div id="layoutSidenav_content" style="background-color: #fafafa">
        <main>
            <div class="container-fluid" style="width: 70%;">
                <h3 class="my-3" style="color: #2e2d2d">Tambah Jenis Dokumen <b
                    ...
                    <div class="col">
                        <div class="card mb-4">
                            <div class="card-header" style="background-color: #2e2d2d;">
                                ...
                                <b style="color: white;">Form Pengisian Jenis Dokumen</b>
                            </div>
                            <div class="card-body">
                                <div class="container overflow-hidden">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="row mb-3" style="align-items: center; justify-content: center;">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputktgr1" name="inputktgr1"
                                                    value="<?php if (isset($ktgr1))
                                                        echo $ktgr1 ?>">
